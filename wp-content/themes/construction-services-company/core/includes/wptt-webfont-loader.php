...
if ( ! class_exists( 'Construction_Services_Company_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Construction_Services_Company_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Construction_Services_Company_WPTT_WebFont_Loader( $url );
